...
[Nsight Compute](https://github.com/modular/modular/blob/modular/v26.3/max/docs/kernel-profiling.md),
or our purpose-built
[`kbench` tool](https://github.com/modular/modular/tree/modular/v26.3/max/kernels/benchmarks/autotune#readme)
...
calling
[`InferenceSession.gpu_profiling()`](/max/api/python/generated/max.engine.InferenceSession#max.engine.InferenceSession.gpu_profiling)
...
Compute](https://github.com/modular/modular/blob/modular/v26.3/max/docs/kernel-profiling.md):
A companion to Nsight Systems for kernel-level profiling on NVIDIA GPUs.

- [`kbench`
tool](https://github.com/modular/modular/tree/modular/v26.3/max/kernels/benchmarks/autotune#readme):
