...
- Added support for while loops with
  [`ops.while_loop`](/max/api/python/graph#max.graphs.ops.while_loop).

- Added support for conditional execution with
  [`ops.cond`](/max/api/python/graph#max.graph.ops.cond).
...
- The [`gelu()`](/max/api/python/graph.ops#max.graph.ops.gelu) function now
  accepts
...
Mojo](https://github.com/modular/modular/tree/modular/v26.3/mojo/examples/gpu-functions),
...
- [`fused_attention`](https://github.com/modular/modular/blob/modular/v26.3/max/examples/custom_ops/kernels/fused_attention.mojo)
  demonstrates complex GPU programming using MAX abstractions for a
  practical use in AI model development.

- [`matrix_multiplication`](https://github.com/modular/modular/blob/modular/v26.3/max/examples/custom_ops/kernels/matrix_multiplication.mojo)
  includes a series of progressive optimizations for matrix multiplications
  on GPUs.

- [`histogram`](https://github.com/modular/modular/blob/modular/v26.3/max/examples/custom_ops/kernels/histogram.mojo)
  shows how to implement the histogram pattern as a custom op.

- New
  [examples for GPU programming in Mojo](https://github.com/modular/modular/tree/modular/v26.3/mojo/examples/gpu-functions)
