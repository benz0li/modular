...
- **Upgraded MAX models**
  ...
  [`llama3`](https://github.com/modular/modular/tree/modular/v26.3/max/pipelines/architectures/llama3)
...
- [Benchmark MAX
  Serve](https://github.com/modular/modular/tree/modular/v26.3/benchmark)
...
[models on GitHub](https://github.com/modular/modular/tree/modular/v26.3/max/pipelines/architectures)
now support GPUs!
...
[`max.pipelines`](/max/api/python/pipelines) package and some of it is alongside
the
[models on GitHub](https://github.com/modular/modular/tree/modular/v26.3/max/pipelines/architectures).
...
- Expanded set of model abstractions for use by different LLM architectures:
  ...
  - Attention layers (including highly optimized implementations with
    ...
    [`AttentionWithRope`](https://github.com/modular/modular/tree/modular/v26.3/max/nn/attention/attention_with_rope.py)).
  ...
  - Transformers such as
    [`Transformer` and `TransformerBlock`](https://github.com/modular/modular/tree/modular/v26.3/max/nn/transformer/transformer.py).
  ...
  - Common layers such as
    [`RMSNorm`](https://github.com/modular/modular/tree/modular/v26.3/max/nn/norm/rms_norm.py),
    [`Embedding`](https://github.com/modular/modular/tree/modular/v26.3/max/nn/embedding.py),
    and
    [`Sequential`](https://github.com/modular/modular/tree/modular/v26.3/max/nn/sequential.py).

  - KV cache management helpers, like
  `ContinuousBatchingKVCacheManager`.

  - Low-level wrappers over optimized kernels like
    [`fused_qk_ragged_rope`](https://github.com/modular/modular/tree/modular/v26.3/max/nn/kernels.py).
...
- Added generalized interfaces for text generation such as
  [`TokenGenerator`](/max/api/python/pipelines.lib.interfaces#max.pipelines.interfaces.TokenGenerator)
  and [`PipelineModel`](/max/api/python/generated/max.pipelines.PipelineModel),
  which provide modularity within the models and serving infrastructure. Also
  added a plug-in mechanism
  ([`PipelineRegistry`](/max/api/python/generated/max.pipelines.lib.registry.PipelineRegistry))
  ...
  - An optimized
    [`TextGenerationPipeline`](/max/api/python/generated/max.pipelines.TextGenerationPipeline)
...
3](https://github.com/modular/modular/tree/modular/v26.3/max/pipelines/architectures/llama3),
...
- [Mistral
NeMo](https://github.com/modular/modular/tree/modular/v26.3/max/pipelines/architectures/mistral)
(and other `MistralForCausalLM` models)

- [Replit Code V1.5
3B](https://github.com/modular/modular/tree/modular/v26.3/max/pipelines/architectures/replit)
...
- `Model.execute()` signature changed to support GPUs.
  ...
  - The [`execute()`](/max/api/python/engine#max.engine.Model.execute) function
    ...
    a [`driver.Tensor`](/max/api/python/driver#max.driver.Tensor), `int`,
    `float`, `bool`,
...
[`AlgebraicDim`](/max/api/python/generated/max.graph.AlgebraicDim),
...
[`TensorValue`](/max/api/python/generated/max.graph.TensorValue)
...
- Added
[`BufferValue`](/max/api/python/generated/max.graph.BufferValue),
...
- [`Value`](/max/api/python/generated/max.graph.Value) constructor
accepts more types for `value`.

- [`TensorValue`](/max/api/python/generated/max.graph.TensorValue)
constructor accepts more types for `value`.

- [`TensorValue.rebind()`](/max/api/python/generated/max.graph.TensorValue#max.graph.TensorValue.rebind)
accepts a new `message` argument.

**Breaking changes:**

- [`Graph.add_weight()`](/max/api/python/generated/max.graph.Graph#max.graph.Graph.add_weight)
now accepts
[`Weight`](/max/api/python/generated/max.graph.Weight#max.graph.Weight)
and returns
[`TensorValue`](/max/api/python/generated/max.graph.TensorValue).
[`Weight`](/max/api/python/generated/max.graph.Weight#max.graph.Weight)
is essentially a
...
- The [`Weight`](/max/api/python/generated/max.graph.Weight#max.graph.Weight)
  constructor
...
examples](https://github.com/modular/modular/tree/modular/v26.3/max/examples/custom_ops).
...
changelog](https://www.mojolang.org/releases#v246-2024-12-17).
