...
examples](https://github.com/modular/modular/tree/modular/v26.3/max/examples) include a
...
<Tabs groupId="install">
  <TabItem value="pixi" label="conda/pixi">
    ...
    - MAX tools and libraries:
      ...
      - [`max` Mojo library](https://www.mojolang.org/docs/lib)
      - [MAX Engine C API](/max/api/c/)
    - The `mojo` package:
      - [`mojo` CLI](https://www.mojolang.org/docs/cli) (includes the Mojo compiler)
      - [Mojo standard library](https://www.mojolang.org/docs/lib)
      - Mojo language server (LSP) for IDE/editor integration
      - [Mojo debugger](https://www.mojolang.org/docs/tools/debugging) (includes LLDB)
      - [Mojo code formatter](https://www.mojolang.org/docs/cli/format)
      - [Mojo REPL](https://www.mojolang.org/docs/cli/repl)
...
guide](https://www.mojolang.org/docs/manual/install).
...
details, see the
[Mojo system requirements](https://www.mojolang.org/docs/requirements#apple-silicon-gpus).
...
the
[Mojo system requirements](https://www.mojolang.org/docs/requirements#gpu-compatibility)
page.

- To deploy MAX in containers, see the [deployment guide](/max/deploy/).
