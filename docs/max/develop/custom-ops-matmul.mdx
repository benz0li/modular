...
[layouts](https://mojolang.org/docs/layout/layout/) and
[`TileTensor`](https://mojolang.org/docs/layout/tile_tensor/TileTensor) to
...
and [Using `LayoutTensor`](https://mojolang.org/docs/manual/layout/tensors)
...
The
[`GenericToSharedAsyncTileCopier`](https://mojolang.org/docs/layout/tile_io/GenericToSharedAsyncTileCopier)
...
the
[`TileTensor.vectorize()`](https://mojolang.org/docs/layout/tile_tensor/TileTensor#vectorize)
...
- See the [GPU programming](https://mojolang.org/docs/manual/gpu/gpu-basics)
  page in the Mojo manual.

- See the [`gpu`](https://mojolang.org/docs/std/gpu/) module for detail on
  Mojo's GPU programming functions and types, and the documentation on
  [`@compiler.register`](https://mojolang.org/docs/manual/decorators/compiler-register/)
