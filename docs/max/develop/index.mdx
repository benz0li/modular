...
- **Compilation**: Call `session.load(graph, weights_registry=state_dict)` to
  compile the graph into an optimized `Model`.
...
- **Contribute**: to add your architecture to the MAX repo, register it in
  ...
  For details, see
  [Contributing new model architectures](https://github.com/modular/modular/blob/modular/v26.3/max/docs/contributing-models.md).
