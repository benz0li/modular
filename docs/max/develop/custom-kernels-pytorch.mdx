...
github_url: https://github.com/modular/modular/tree/modular/v26.3/max/examples/pytorch_custom_ops
show_languages: true
is_tutorial: true
---
...
The [`max.torch`](/max/api/python/experimental.torch) module provides
...
struct Grayscale:
    ...
    def execute[
        ...
        def color_to_grayscale[
            ...
            @parameter
            def load(idx: IndexList[img_in.rank]) -> SIMD[DType.float32, simd_width]:
