...
github_url: https://github.com/modular/modular/tree/modular/v26.3/max/examples/embedding-knowledge-base/
---
...
MAX supports the
[`v1/embeddings`](/max/rest-api/#POST/v1/embeddings) endpoint, which is
...
[REST API documentation](/max/rest-api/).
