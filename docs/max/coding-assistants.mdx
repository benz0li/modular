...
- <a href="/llms.txt"><code>llms.txt</code></a> for a list of links with brief
  descriptions
- <a href="/llms-full.txt"><code>llms-full.txt</code></a> for comprehensive
  documentation (requires large context window)
- <a href="/llms-python.txt"><code>llms-python.txt</code></a> for MAX Python
  APIs, pipelines, or graph construction
- <a href="/llms-mojo.txt"><code>llms-mojo.txt</code></a> for Mojo code, GPU
  kernels, or MAX library APIs
...
[`CLAUDE.md`](https://github.com/modular/modular/blob/modular/v26.3/CLAUDE.md) and
[`AGENTS.md`](https://github.com/modular/modular/blob/modular/v26.3/AGENTS.md)
...
[Critical development notes](https://github.com/modular/modular/blob/modular/v26.3/CLAUDE.md#critical-development-notes),
...
- **[`general_behavior_rules.mdc`](https://github.com/modular/modular/blob/modular/v26.3/.cursor/rules/general_behavior_rules.mdc)**:
...
- **[`git.mdc`](https://github.com/modular/modular/blob/modular/v26.3/.cursor/rules/git.mdc)**:
Best practices for Git including code organization, commit strategies,
branching models, and collaborative workflows.

- **[`max_development.mdc`](https://github.com/modular/modular/blob/modular/v26.3/.cursor/rules/max_development.mdc)**:
Guidelines for MAX development covering project context, task execution, code
quality, testing practices, and documentation.

- **[`mojo.mdc`](https://github.com/modular/modular/blob/modular/v26.3/.cursor/rules/mojo.mdc)**:
...
`AGENTS.md` files—our
[`AGENTS.md`](https://github.com/modular/modular/blob/modular/v26.3/AGENTS.md) file is
just a symlink to the
[`CLAUDE.md`](https://github.com/modular/modular/blob/modular/v26.3/CLAUDE.md) file.
