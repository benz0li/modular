...
github_url: https://github.com/modular/modular/blob/modular/v26.3/max/examples/cloud-configs/
is_tutorial: true
---
...
Hugging Face model ID from our [supported models](/max/models/). Just
...
for chat completion](/max/rest-api/#POST/v1/chat/completions).
...
[available containers](/max/container#container-contents).
...
[`max benchmark` docs](/max/cli/benchmark).
