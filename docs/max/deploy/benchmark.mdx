...
script source
here](https://github.com/modular/modular/tree/modular/v26.3/max/python/max/benchmark).
...
[`gemma-3-27b-sonnet-decode-heavy-prefix200.yaml`](https://github.com/modular/modular/tree/modular/v26.3/max/python/max/benchmark/configs/gemma-3-27b-sonnet-decode-heavy-prefix200.yaml)
...
[MAX benchmarking key metrics](https://github.com/modular/modular/tree/modular/v26.3/max/python/max/benchmark#key-metrics-explained).
