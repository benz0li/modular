...
[managed cloud](/max/deploy/cloud) solution, Modular's infrastructure in your
...
[`max serve`](/max/cli/serve). Choose whether you want **text-to-text**,
...
[compatible GPU](/max/packages#gpu-compatibility) is required.
...
[compatible GPU](/max/packages#gpu-compatibility). They aren't gated on
...
[benchmark config files on GitHub](https://github.com/modular/modular/tree/modular/v26.3/max/python/max/benchmark/configs).
